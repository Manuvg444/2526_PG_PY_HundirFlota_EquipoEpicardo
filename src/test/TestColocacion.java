...
import main.nave.tipos.*;
import main.nave.defensa.*;
...
public class TestColocacion {
    ...
    private static void testColocacionValida() {
        ...
        // (Esto requiere que tengas acceso a consultar casilla, o intentar colocar
        // encima)
    ...
    // t.colocarBarco(new Submarino(new BlindajeSimple()), new Coordenada("C5"),
    // Direccion.SUR);

    // // Intentamos cruzar con un Destructor (2) en D4 al ESTE (D4, D5) -> Choca en
    // D5
    // boolean cruce = t.colocarBarco(new Destructor(new BlindajeSimple()), new
    // Coordenada("D4"), Direccion.ESTE);
