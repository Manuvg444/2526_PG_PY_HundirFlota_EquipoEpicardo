...
public class TestHabilidades {
    ...
    private static void testTiposDeAtaque() {
        ...
        assert porta.getAtaqueEspecial() == TipoAtaqueEnum.R_AEREO : "Error:Portaaviones debe ser RADAR";

        Barco acora = new Acorazado(new BlindajeSimple());
        assert acora.getAtaqueEspecial() == TipoAtaqueEnum.B_ZONA : "Error: Acorazadodebe ser ZONA";

        Barco buque = new Buque(new BlindajeSimple());
        assert buque.getAtaqueEspecial() == TipoAtaqueEnum.A_CRUZ : "Error: Buque debeser CRUZ";
